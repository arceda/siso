...
class Dataset():
    ...
    def __init__(self, seq_length=10, class_limit=2, image_shape=(56, 24, 3)):
        self.seq_length = seq_length
        self.class_limit = class_limit
        self.sequence_path = os.path.join('data_10', 'sequences')
        # Get the data.
    ...
    def get_data(self):
        with open(os.path.join('data_10', 'data_file_10.csv'), 'r') as fin:
    ...
    def get_extracted_sequence(self, video):
        ...
        filename = video[2]
        path = os.path.join(self.sequence_path, filename + '-' + str(10) +
                            '-' + 'features' + '.npy')
